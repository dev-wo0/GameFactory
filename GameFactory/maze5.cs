...
{
    public partial class maze5 : Form
    {
        maze1 form1;
        maze4 form4;
        private Pen pen;
        ...
        public maze5(maze1 fom1, maze4 fom4)
        { 
            form1 = fom1;
            form4 = fom4;        
            InitializeComponent();
            ...
            for (int a = 0; a < 11; a++)
                for (int b = 0; b < 11; b++)
                    if (position[a, b] == '.')
                    {
                        ...
                        if (form1.mazeA[a, b - 1] == '2')
                        {
                            return;
                        }

                        if (form1.mazeA[a, b - 2] == 'e')
                        {
                            int score;
                            ...
                            for (int x = 0; x < 11; x++)
                                for (int y = 0; y < 11; y++)
                                {
                                    ...
                                    if (form1.mazeB[x, y] == '1')
                                    {
                                        if (x % 2 == 1)
                                        {
                                            form4.g.DrawImage(Ver, (y / 2 * 100) + 45, ((x + 1) / 2 * 100) - 50);
                                        }

                                        if (x % 2 == 0)
                                        {
                                            form4.g.DrawImage(Hor, ((y + 1) / 2 * 100) - 50, (x / 2 * 100) + 45);
                                        }
                                    }
                                }

                            MessageBox.Show("PlayerB win!!! ");
                            score = ++form1.playerB_score;
                            form1.label4.Text = score.ToString();
            ...
            for (int a = 0; a < 11; a++)
                for (int b = 0; b < 11; b++)
                    if (position[a, b] == '.')
                    {
                        ...
                        if (form1.mazeA[a - 1, b] == '2')
                        {
                            return;
                        }

                        if (form1.mazeA[a - 2, b] == 'e')
                        {
                            int score;
